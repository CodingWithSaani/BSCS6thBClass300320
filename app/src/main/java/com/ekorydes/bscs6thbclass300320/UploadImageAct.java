                    ...
                    objectUploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                        ...
                        public Task<Uri> then(@NonNull Task<UploadTask.TaskSnapshot> task) throws Exception {
                                        ...
                                        objectFirebaseFirestore.collection("BSCSLinks")
                                                ...
                                                .addOnSuccessListener(new OnSuccessListener<Void>() {
                                                    ...
                                                    public void onSuccess(Void aVoid) {
                                                        objectDialog.dismiss();
                                                        Toast.makeText(UploadImageAct.this, "Image Uploaded" +
                                                ...
                                                .addOnFailureListener(new OnFailureListener() {
                                                    ...
                                                    public void onFailure(@NonNull Exception e) {
                                                        objectDialog.dismiss();
                                                        Toast.makeText(UploadImageAct.this, "Fails to upload image", Toast.LENGTH_SHORT).show();
                                                    }
                                                });
                                    } else {
                                        objectDialog.dismiss();
                                        Toast.makeText(UploadImageAct.this, "Msg from Firebase:" +
                            ...
                            .addOnFailureListener(new OnFailureListener() {
                                ...
                                public void onFailure(@NonNull Exception e) {
                                    objectDialog.dismiss();
                                    Toast.makeText(UploadImageAct.this, "Firebase Storage Response:"
                                            + e.getMessage(), Toast.LENGTH_SHORT).show();
                                }
                            });
